      ...
      <?php if ($_REQUEST['type']=="debit" OR $_REQUEST['type']=="both"): ?>
                ...
                <div class="row contacts">
                    ...
                    <div class="col invoice-details">
                        ...
                        <div class="font-weight-bold text-dark date">Voucher Date/Time: <?=$vouchers['timestamp']?></div>
                        <?php  if (!empty($vouchers['editby_user_id'])) {
                                     $users=fetchRecord($dbc,"users","user_id",$vouchers['editby_user_id']);
                                ?>    
                        <div class="font-weight-bold text-dark date">Edit By: <?=$users['fullname']?></div>

                             <?php   }else {
                                     $users=fetchRecord($dbc,"users","user_id",$vouchers['addby_user_id']);
                                      ?>
                                      <div class="font-weight-bold text-dark date">Added By: <?=$users['fullname']?></div>
                              <?php   } ?>
                  ...
                  <div class="col-sm-12">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-left"><h3><?=$vouchers['voucher_amount']?></h3></td>
                            <td class="unit"><h3>Previous Balance</h3></td>
                            <td class="qty"><?=$previous_balance?></td>
                            <td class="total"><h3>Current Balance</h3></td>
                            <td class="qty"><?=$from_balance['from_balance']?></td>
                        </tr>
                        <tr>
                  ...
                  <div class="col-sm-12">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-left"><h3><?=$vouchers['voucher_amount']?></h3></td>
                            <td class="unit"><h3>Previous Balance</h3></td>
                            <td class="qty"><?=$previous_balance2?></td>
                            <td class="total"><h3>Current Balance</h3></td>
                            <td class="qty"><?=$from_balance2['from_balance']?></td>
                        </tr>
                        <tr>
                            <td class="no">Narration</td>
                            <td colspan="5"  class="text-center no"><?=ucfirst($vouchers['voucher_hint'])?></td>
