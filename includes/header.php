...
// Determine credit sale type
if (isset($_REQUEST['credit_type']) && $_REQUEST['credit_type'] == "15days") {
  $credit_sale_type = "15days";
  $credit_sale_type_text = "15 days";
} elseif (isset($_REQUEST['credit_type']) && $_REQUEST['credit_type'] == "30days") {
...
<nav class="navbar navbar-expand-lg navbar-light bg-white flex-row border-bottom shadow">
  <div class="container-fluid">
    <a class="navbar-brand d-flex align-items-center mx-lg-1 mr-0" href="dashboard.php">
      <img src="img/logo/<?= $get_company['logo'] ?>"
        class="img-fluid"
        alt="Logo"
        style="max-width: 100%; height: auto; width: 80px; min-width: 30px;">
    </a>

    <button class="navbar-toggler mt-2 mr-auto toggle-sidebar text-muted" type="button">
            ...
            $getChild = mysqli_query(
              ...
              "SELECT * FROM menus 
                       WHERE parent_id = '{$fetch_nav['id']}' 
                         ...
                         AND id NOT IN ('111', '132')"  // Add more IDs as needed
            );
                  ...
                  <div class="dropdown-menu" aria-labelledby="ui-elementsDropdown">
                    ...
                    $getChild = mysqli_query(
                      ...
                      "SELECT * FROM menus 
                       WHERE parent_id = '{$fetch_nav['id']}' 
                         AND page != 'dashboard.php' 
                         AND id NOT IN ('111', '132','143')"  // Add more IDs as needed
                    );
                    while ($child = mysqli_fetch_assoc($getChild)) {
                    ?>
                      <a class="nav-link pl-lg-2" href="<?= $child['page'] ?>">
