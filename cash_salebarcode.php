            ...
            <div class="row form-group">
              <div class="col-md-3">
                ...
                <label>Order Type</label>
                    <select class="form-control ratetype" name="ratetype" id="ratetype">
              ...
              <div class="form-group row">
                <div class="col-2 col-md-2">
                    <label class="float-right">Product Barcode</label>
                </div>
                    <div class="col-6 col-md-6">
                    
                      <input type="text" placeholder="Focus here while Scaning Product Barcode"  name="barcode_product" autocomplete="off" id="barcode_product" class="form-control">
                    </div>
